...
export const columns = [
  ...
  { name: "شماره تماس گزارش دهنده", uid: "phone", sortable: true },
  ...
  { name: "کد گزارش", uid: "reportCode" },
  { name: "شرح گزارش", uid: "report" },
...
function Report({ ownerIdCard, goToAds }) {
  ...
  useEffect(() => {
    ...
    const fetchAds = async () => {
      ...
      try {
        const response = await fetch(`/api/ads/report/get/${isAuthUser._id}`);
